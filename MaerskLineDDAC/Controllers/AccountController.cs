...
namespace MaerskLineDDAC.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            // Get Admin Account
            string AdminUserName = ConfigurationManager.AppSettings["StaffUserName"];
            string AdminPassword = ConfigurationManager.AppSettings["StaffPassword"];
            ...
            if (objAdminUser == null)
            {
                ...
                if (!RoleManager.RoleExists("Staff"))
                {
                    ...
                    IdentityRole objAdminRole = new IdentityRole("Staff");
                    RoleManager.Create(objAdminRole);
                }
                if (!RoleManager.RoleExists("Agent"))
                {
                    // Create the Admin Role (if needed)
                    IdentityRole objAgentRole = new IdentityRole("Agent");
                    RoleManager.Create(objAgentRole);
                }
                ...
                UserManager.AddToRole(objNewAdminUser.Id, "Staff");
            }
        }
        #endregion
    }
